...
/**
 * The closing CTA. Its own section rather than a SectionShell: the spec gives it a
 * taller rhythm than every other block — `clamp(64px, 9vw, 130px)` against the
 * standard `clamp(40px, 6vw, 86px)` — and that extra air is what makes it read as the
 * end of the page rather than one more band.
 */
