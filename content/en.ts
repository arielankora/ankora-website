  ...
  pages: {
    ...
    roi: {
      ...
      personas: [
        {
          key: "executives",
          hoursLabel: "How many hours a week go to operational tasks that don't need your judgment?",
          hoursHint: "Scheduling, coordination, follow-up, paperwork",
          hoursDefault: 8,
          rateLabel: "What's the estimated value of an hour of your time?",
          rateHint: "Based on the value you create in a free working hour",
          rateDefault: 400,
        },
        {
          key: "founders",
          hoursLabel: "How many hours a week go to operational management instead of growing the business?",
          hoursHint: "Vendors, paperwork, coordination",
          hoursDefault: 10,
          rateLabel: "What's the estimated value of an hour of your time?",
          rateHint: "Based on the value you create in a free working hour",
          rateDefault: 350,
        ...
        {
          key: "companies",
          hoursLabel: "How many hours a week does the company spend on operations outside its core business?",
          hoursHint: "Vendors, admin, internal coordination",
          hoursDefault: 15,
          rateLabel: "What's the estimated value of a management hour?",
          rateHint: "Based on the cost of the managerial time invested",
          rateDefault: 300,
        },
        {
          key: "familyOffice",
          hoursLabel: "How many hours a week go to coordinating properties, vendors, and household matters?",
          hoursHint: "Maintenance, vendors, general coordination",
          hoursDefault: 6,
          rateLabel: "What's the estimated value of an hour of your time?",
          rateHint: "Based on the value you create in a free working hour",
          rateDefault: 250,
      ...
      results: {
        ...
        valueFreedLabel: "Value of time freed",
        costLabel: "Estimated Ankora cost",
        netValueLabel: "Net monthly value",
        multipleLabel: "A return of",
        multipleSuffix: "on every shekel spent",
        ctaBody: "These numbers are an estimate. A short intro call will give you an exact picture.",
        cta: "Book an intro call",
        footnote: "* This calculation is illustrative only, based on the figures entered and Ankora's example rates. It does not constitute a price quote or commitment.",
      },
    },
    pricing: {
      eyebrow: "Pricing",
